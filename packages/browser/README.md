...
// Only enable in development (URLs stay clean, no query params needed)
...
> **Note**: Page URLs do not require query parameters (`?session=` or `?port=`). Clean URLs work out of the box.
